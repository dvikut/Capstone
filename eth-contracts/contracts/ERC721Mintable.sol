...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to, 'Self approve not permitted');

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), 'Sender is not the owner nor approved for all');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "Transfer is not from owner");
...
contract ShantyToken is ERC721Metadata("Shanty Token","ST","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
